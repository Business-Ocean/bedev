...
import (
	...
	"github.com/business-ocean/bedev/console/convert/sample"
...
func (r *convert) Short() string {
	return "convert command used for convert some cool developer stuffs."
}

func (r *convert) Setup(cmd *cobra.Command) {
	cmd.AddCommand(getSubCommands(convertModules)...)
}

func (r *convert) Run() cmd.CommandRunner {
	return func() {
		items := []list.Item{}
		for key := range cmds {
