...
import (
	...
	"github.com/business-ocean/bedev/console/clean/sample"
...
func (r *clean) Short() string {
	return "clean command used for clean some cool developer stuffs."
}

func (r *clean) Setup(cmd *cobra.Command) {
	cmd.AddCommand(getSubCommands(cleanModules)...)
}

func (r *clean) Run() cmd.CommandRunner {
	return func() {
		items := []list.Item{}
		for key := range cmds {
